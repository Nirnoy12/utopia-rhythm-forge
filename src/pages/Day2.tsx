...
const artistsDay2 = [
  ...
  {
  name: "Fashion Show",
  role: "The Fashion Runway and Performance",
  time: "To Be Announced",
  image: "https://iso.500px.com/wp-content/uploads/2020/02/Christophe-Josse-Finale-By-Milton-Tan.jpeg",
  registerLink: "",
  description: "Experience a stunning fashion runway where style meets creativity. Watch participants showcase unique designs, confidence, and stage presence in an electrifying atmosphere.\n\nVenue: Main Stage",
},
{
  name: "Performance by UTOPIA 2K26 Student Committee",
  role: "Dance and Entertainment Performance",
  time: "To Be Announced",
  image: "https://i.pinimg.com/1200x/94/35/85/943585b7c5d1cf5f2fb0ffccb79fc4be.jpg",
  registerLink: "",
  description: "Get ready for an electrifying performance by the UTOPIA 2K26 student committee. A vibrant mix of dance, music, and high-energy entertainment that sets the stage on fire and keeps the audience engaged throughout.\n\nVenue: Main Stage",
},
  {
